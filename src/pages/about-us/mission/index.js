...
export default () => {
  return (
    <>
      ...
      <p>
        The mission of CeDRI is to contribute to the development, application and transfer of scientific knowledge related to robotics, intelligent systems, and information and communication technologies, in the scope of the digitalization and automation of industrial systems, strengthening the scientific and technological system.
      </p>
    </>
  )
}
